...
> A design system for ui-tests UI components, built on [@design-systems/cli](https://github.com/intuit/design-systems-cli).

## 👍 Philosophy

This is a design system intended for UI components currently being built or tested in ui-tests.
...
For an example we will try to use the `@ui-tests/card` component.

```sh
npm i @ui-tests/card
# or with yarn
yarn add @ui-tests/card
```
...
Now whenever you import one of the `@ui-tests` components, `babel` will automatically include the correct CSS file!
